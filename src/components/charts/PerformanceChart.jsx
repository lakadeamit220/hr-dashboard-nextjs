...
export default function PerformanceChart({ data }) {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-[2px] border border-blue-300 shadow-sm rounded-xl p-6 flex flex-col h-full animate-fade-in" style={{ animationDelay: '100ms' }}>
