...
export default function KpiCard({ title, value, icon: Icon, trend, colorClass = "primary" }) {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-[2px] border border-slate-300/70 shadow-sm rounded-xl p-6 shadow-card hover:shadow-card-hover transition-shadow duration-300 animate-slide-up border border-slate-300/70 flex items-center justify-between">
