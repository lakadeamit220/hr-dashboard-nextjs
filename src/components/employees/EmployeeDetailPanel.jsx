      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{new Date(employee.joiningDate).toLocaleDateString()}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {employee.documents.map(doc => (
              <div key={doc.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                <div className="w-10 h-10 rounded bg-white border border-gray-100 flex items-center justify-center text-blue-600 shrink-0">
