  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div className="w-16 h-16 rounded-full overflow-hidden border border-blue-300 bg-gray-100 flex items-center justify-center shrink-0">
          {avatarPreview ? (
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center">
            <label className="cursor-pointer inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 backdrop-blur-[2px] border border-blue-300 shadow-sm border border-blue-300 rounded-md text-sm font-medium text-blue-800 hover:bg-white/90 transition-colors">
              <Upload size={16} />
        ...
        <div className="pt-4 border-t border-blue-300">
          ...
          <div className="space-y-2">
            {employee.documents.map(doc => (
              <div key={doc.id} className="flex items-center justify-between p-3 bg-gray-50 border border-blue-300 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white/5 backdrop-blur-[2px] border border-blue-300 shadow-sm rounded-md text-blue-600 border border-blue-300">
      ...
      <div className={`flex items-center pt-4 border-t border-blue-300 ${isEditing ? 'justify-between' : 'justify-end'}`}>
        {isEditing && (
          <Button 
            variant="danger" 
            type="button" 
