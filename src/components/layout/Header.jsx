    ...
    <header className="h-16 bg-white/5 backdrop-blur-[2px] border border-slate-300/70 shadow-sm border-b border-slate-300/70 flex items-center justify-between px-4 sm:px-6 z-10 sticky top-0">
      <div className="flex items-center gap-4">
        <button 
          ...
          className="lg:hidden p-2 -ml-2 text-slate-500 hover:text-slate-700 hover:bg-slate-100/50 rounded-lg"
        >
          <Menu size={20} />
        </button>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <button className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-50/50 rounded-full transition-colors hidden sm:block">
          <Search size={20} />
        </button>
        
        <button className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-50/50 rounded-full transition-colors relative">
          <Bell size={20} />
